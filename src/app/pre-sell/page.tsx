...
export default function PreSellPage() {
  ...
  return (
    <div className="flex flex-col gap-3 min-h-screen justify-center bg-[url('../assets/background-image.jpg')] bg-cover backdrop-blur-sm ba-indigo-950/75 backdrop-brightness-75 px-2 py-4">
      <Logo />
      {renderComponent()}
    </div>
  )
